...
class femaleProduct{
      ...
      async getImage(){
            let baseUrl = "https://api.pexels.com/v1/search?query= women's fashion per_page=16;"
      ...
      async getSearchedImages(e){
            ...
            const baseUrl = await  `https://api.pexels.com/v1/search?query= ${searchValue} per_page=10`
            const data =  await this.fetchImages(baseUrl);
...
const showcaseContent = new femaleProduct;
